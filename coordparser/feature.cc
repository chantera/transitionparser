...
FeatureVector Feature::extract(const State &state) {
  ...
  return {
      ...
      rc1_rc1_s1.tag,
      // label features
      lc1_s0.id != -1 ? (unsigned) state.labels_[lc1_s0.id] : pad.label,
      rc1_s0.id != -1 ? (unsigned) state.labels_[rc1_s0.id] : pad.label,
      lc2_s0.id != -1 ? (unsigned) state.labels_[lc2_s0.id] : pad.label,
      rc2_s0.id != -1 ? (unsigned) state.labels_[rc2_s0.id] : pad.label,
      lc1_s1.id != -1 ? (unsigned) state.labels_[lc1_s1.id] : pad.label,
      rc1_s1.id != -1 ? (unsigned) state.labels_[rc1_s1.id] : pad.label,
      lc2_s1.id != -1 ? (unsigned) state.labels_[lc2_s1.id] : pad.label,
      rc2_s1.id != -1 ? (unsigned) state.labels_[rc2_s1.id] : pad.label,
      lc1_lc1_s0.id != -1 ? (unsigned) state.labels_[lc1_lc1_s0.id] : pad.label,
      rc1_rc1_s0.id != -1 ? (unsigned) state.labels_[rc1_rc1_s0.id] : pad.label,
      lc1_lc1_s1.id != -1 ? (unsigned) state.labels_[lc1_lc1_s1.id] : pad.label,
      rc1_rc1_s1.id != -1 ? (unsigned) state.labels_[rc1_rc1_s1.id] : pad.label,
  };
}
