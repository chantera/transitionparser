...
MlpClassifier::MlpClassifier(const unsigned word_vocab_size,
...
MlpClassifier::MLP::MLP(dynet::Model &model,
    ...
    p_lookup_w_(model.add_lookup_parameters(word_vocab_size, {word_embed_size})),
    p_lookup_p_(model.add_lookup_parameters(pos_vocab_size, {pos_embed_size})),
    p_lookup_l_(model.add_lookup_parameters(label_vocab_size, {label_embed_size})),
